...
import org.quickfixj.messages.bd.fix43.ExecutionReport;
import org.quickfixj.messages.bd.fix43.NewOrderSingle;
import org.quickfixj.messages.bd.fix43.OrderCancelReplaceRequest;
import org.quickfixj.messages.bd.fix43.OrderCancelRequest;
import org.quickfixj.messages.bd.fix43.field.AvgPx;
import org.quickfixj.messages.bd.fix43.field.BusinessRejectReason;
import org.quickfixj.messages.bd.fix43.field.ClOrdID;
import org.quickfixj.messages.bd.fix43.field.CumQty;
import org.quickfixj.messages.bd.fix43.field.ExecID;
import org.quickfixj.messages.bd.fix43.field.HandlInst;
import org.quickfixj.messages.bd.fix43.field.LeavesQty;
import org.quickfixj.messages.bd.fix43.field.LocateReqd;
import org.quickfixj.messages.bd.fix43.field.MsgType;
import org.quickfixj.messages.bd.fix43.field.OrdStatus;
import org.quickfixj.messages.bd.fix43.field.OrdType;
import org.quickfixj.messages.bd.fix43.field.OrderQty;
import org.quickfixj.messages.bd.fix43.field.OrigClOrdID;
import org.quickfixj.messages.bd.fix43.field.Price;
import org.quickfixj.messages.bd.fix43.field.RefSeqNum;
import org.quickfixj.messages.bd.fix43.field.SessionRejectReason;
import org.quickfixj.messages.bd.fix43.field.Side;
import org.quickfixj.messages.bd.fix43.field.StopPx;
import org.quickfixj.messages.bd.fix43.field.Symbol;
import org.quickfixj.messages.bd.fix43.field.Text;
import org.quickfixj.messages.bd.fix43.field.TimeInForce;
import org.quickfixj.messages.bd.fix43.field.TransactTime;

import quickfix.BusinessRejectReasonText;
import quickfix.FieldNotFound;

public class BanzaiHandler43 extends BanzaiHandler {
    ...
    public BanzaiHandler43(BanzaiApplication application) {
        super(application);
    }
    ...
    private void sendSessionReject(FIXSessionID sessionID, FIXMessage message,
        ...
        FIXMessage reply = getApplication().createMessage(sessionID, FIXApplication.FIX43,
    ...
    public void send(Order order) {
        NewOrderSingle newOrderSingle = new NewOrderSingle(new ClOrdID(order.getID()),
                HandlInst.AUTOMATED_EXECUTION_ORDER_PRIVATE, sideToFIXSide(order.getSide()),
