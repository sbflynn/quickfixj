...
import quickfix.fix50.field.AvgPx;
import quickfix.fix50.field.BusinessRejectReason;
import quickfix.fix50.field.ClOrdID;
import quickfix.fix50.field.CumQty;
import quickfix.fix50.field.ExecID;
import quickfix.fix50.field.HandlInst;
import quickfix.fix50.field.LeavesQty;
import quickfix.fix50.field.LocateReqd;
import quickfix.fix50.field.MsgType;
import quickfix.fix50.field.OrdStatus;
import quickfix.fix50.field.OrdType;
import quickfix.fix50.field.OrderQty;
import quickfix.fix50.field.OrigClOrdID;
import quickfix.fix50.field.Price;
import quickfix.fix50.field.RefSeqNum;
import quickfix.fix50.field.SessionRejectReason;
import quickfix.fix50.field.Side;
import quickfix.fix50.field.StopPx;
import quickfix.fix50.field.Symbol;
import quickfix.fix50.field.Text;
import quickfix.fix50.field.TimeInForce;
import quickfix.fix50.field.TransactTime;
...
public class BanzaiHandler50 extends BanzaiHandler {
    ...
    public BanzaiHandler50(BanzaiApplication application, OrderTableModel orderTableModel,
    ...
    public void sendBusinessReject(SessionID sessionID, Message message, int rejectReason,
        ...
        reverseRoute(message, reply);
        reply.setString(RefSeqNum.TAG, message.getHeader().getString(FixTags.MSG_SEQ_NUM));
        reply.setString(FixTags.REF_MSG_TYPE, message.getHeader().getString(FixTags.MSG_TYPE));
    ...
    private Message createMessage(SessionID sessionID, MsgType msgType) throws FieldNotFound {
        return application
                .getMessageFactory()
                .getMessageBuilder(sessionID.getBeginString(), FIXApplication.FIX50,
