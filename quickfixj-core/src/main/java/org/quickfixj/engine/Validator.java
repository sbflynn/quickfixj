...
/**
 * Validator - resposible for validating a {@link FIXMessage} with respect to a {@link FIXMessageDictionary}.
 *
...
public interface Validator {
     ...
     * @since 2.0
     */
    void validate(FIXMessageDictionary dictionary, FIXMessage message, boolean bodyOnly);
