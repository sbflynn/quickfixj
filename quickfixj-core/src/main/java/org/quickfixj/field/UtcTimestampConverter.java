...
public class UtcTimestampConverter extends AbstractDateTimeConverter {
    ...
    private static HashMap<String, Long> dateCache = new HashMap<String, Long>();
     ...
     * @exception FieldConversionException raised if timestamp is an incorrect format.
     */
    public static Date convert(String value) throws FieldConversionException {
        verifyFormat(value);
    ...
    private static void verifyFormat(String value) throws FieldConversionException {
