...
public class BigDecimalConverter {
     ...
     * @throws FieldConversionException if the String is not a valid decimal pattern.
     */
     ...
     * @return If field value is an BigDecimal then the value, otherwise the field 
     * characters parsed using {@link Double#parseDouble(String)}.
     * @throws FieldException if field value is not a valid format.
     */
