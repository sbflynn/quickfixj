...
public interface DataDictionaryProvider {
    ...
    /**
     * Retrieve the data dictionary for parsing a specific version of the
     * transport header/trailer.
     *
     ...
     *
     * @param applVerID the application version ID. Prior to FIXT.1.1, the
     *        applVerID will be determined by BeginString field.
