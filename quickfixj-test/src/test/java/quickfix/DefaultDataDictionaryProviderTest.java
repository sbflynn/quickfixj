...
public class DefaultDataDictionaryProviderTest {
    ...
    public void returnRegisteredSessonDictionaryWithoutDiscovery() throws Exception {
        ...
        provider.addTransportDictionary(FIXBeginString.FIX42, dictionaryForTest1);
        provider.addTransportDictionary(FIXBeginString.FIX44, dictionaryForTest2);

        DataDictionary dd = provider.getSessionDataDictionary(FIXBeginString.FIX44);
    ...
    public void returnSessionDictionaryWithDiscovery() throws Exception {
        ...
        DataDictionary dd = provider.getSessionDataDictionary(FIXBeginString.FIX40);
    ...
    public void returnRegisteredAppDictionaryWithoutDiscovery() throws Exception {
        ...
        DefaultDataDictionaryProvider provider = new DefaultDataDictionaryProvider(false);
        provider.addApplicationDictionary(FIXApplication.FIX44, dictionaryForTest1);
        provider.addApplicationDictionary(FIXApplication.FIX40, dictionaryForTest2);

        DataDictionary dd = provider.getApplicationDataDictionary(FIXApplication.FIX40);
    ...
    public void testDataDictionaryForFIX50SP() throws Exception {
        ...
        DefaultDataDictionaryProvider provider = new DefaultDataDictionaryProvider();
        provider.getApplicationDataDictionary(FIXApplication.FIX50SP1);
        provider.getApplicationDataDictionary(FIXApplication.FIX50SP2);
    }
}
