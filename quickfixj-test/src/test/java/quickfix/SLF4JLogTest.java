...
public class SLF4JLogTest extends TestCase {
    ...
    public void testLog() throws Exception {
        final SessionID sessionID = new SessionID(FIXBeginString.FIX42, "SENDER"
                + System.currentTimeMillis(), "TARGET" + System.currentTimeMillis());
    ...
    public void testLog4j_correctFQCN() throws Exception {
        ...
        final SLF4JLog slf4jLog = new MySLF4JLog(new SessionID(FIXBeginString.FIX42, "sender",
                "target"), "my-caller-fqcn", myLog4j);
