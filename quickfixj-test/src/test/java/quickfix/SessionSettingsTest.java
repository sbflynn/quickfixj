...
public class SessionSettingsTest extends TestCase {
    ...
    public void testSettings() throws Exception {
        ...
        final SessionID sessionID1 = new SessionID(FIXBeginString.FIX42, "TW", "CLIENT1");
        final SessionID sessionID2 = new SessionID(FIXBeginString.FIX42, "TW", "CLIENT2");
        final SessionID sessionID3 = new SessionID(FIXBeginString.FIX42, "FOO", "BAR");
        ...
        try {
            settings.getString(new SessionID(FIXBeginString.FIX42, "FOO", "BAR"), "xyz");
    ...
    public void testMergedProperties() throws Exception {
        final SessionSettings settings = setUpSession();
        final SessionID sessionID = new SessionID(FIXBeginString.FIX42, "TW", "CLIENT1");
    ...
    public void testVariableInterpolationInDefaultSection() throws Exception {
        ...
        final SessionID sessionID = new SessionID(FIXBeginString.FIX42, "SENDER", "TARGET");
