...
public class ResynchTest {
    ...
    @Test(timeout = 30000)
    public void testAcceptorTimerSync() throws ConfigError, InterruptedException {
        serverThread.start();
    ...
    @Test(timeout = 30000)
    public void testAcceptorTimerUnsyncWithValidatingSequenceNumbers() throws ConfigError,
    ...
    @Test(timeout = 30000)
    public void testAcceptorTimerUnsyncWithoutValidatingSequenceNumbers() throws ConfigError,
            InterruptedException {
        server.setUnsynchMode(true);
