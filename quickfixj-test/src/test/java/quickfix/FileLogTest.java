...
public class FileLogTest {
    ...
    public void testLog() throws Exception {
        ...
        SessionID sessionID = new SessionID(FIXBeginString.FIX42, "SENDER" + systemTime, "TARGET"
                + systemTime);
        ...
        String prefix = sessionID.getBeginString().getValue() + "-" + sessionID.getSenderCompID()
