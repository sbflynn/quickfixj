...
public class SSLAndNonSSLTest {
    ...
    private void doLogonTest(String clientCompId, String port, String useSSL)
        ...
        try {
            ...
            SessionID clientSessionID = new SessionID(FIXBeginString.FIX42, clientCompId, "ISLD");
    ...
    private SessionSettings getClientSessionSettings(SessionID clientSessionID,
            String socketConnectPort, String socketUseSSL) {
    ...
    private class ATServer implements Runnable {
        ...
        public void run() {
            try {
                ...
                defaults.put("SocketAcceptProtocol",
